...
namespace Aula_15_04.DAL
{
    public class ConsultaCursos
    {
        ...
        public static void AdicionarCursos(CursoDTOs curso)
        {
        ...
        public static void DeletarCursos(int ID)
        {
            Conexao minhaConexao = new Conexao();

            string query = $"DELETE FROM tb_cursos WHERE id = {ID};";
        ...
        public static DataTable ListarCursos()
        {
            ...
            // String que recebera a consulta realizada pelo usuario
            string query = "SELECT nome, descricao, carga_horaria, link FROM tb_cursos;";
